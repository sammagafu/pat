...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Project Donor',
                'verbose_name_plural': 'Projects Donors',
            },
        ),
        migrations.CreateModel(
            name='ProjectGoal',
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goals', to='project.project', verbose_name='Project')),
            ],
            options={
