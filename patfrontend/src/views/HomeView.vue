        ...
        <div class="col-lg-7">
          <div class="about-text-box">
            ...
            <ul class="about-core">
              ...
              <li>
                <i class="fas fa-check-double" aria-hidden="true"></i>
                <h4>To establish and maintain a journal of the Association.</h4>
              </li>
              <li>
                <i class="fas fa-check-double" aria-hidden="true"></i>
  ...
  <section class="doctors py-100-70">
    <div class="container">
      <div class="sec-title">
        <div class="row">
          <div class="col-lg-9">
            <h3>Meet Our Executive Council</h3>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="statistic-item">
            ...
            <div class="content">
              ...
              <div class="counter-name">Registered Members</div>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          <div class="statistic-item">
            ...
            <div class="content">
              ...
              <div class="counter-name">Governing Memebers</div>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          <div class="statistic-item">
            ...
            <div class="content">
              <div class="statistic-counter">42</div>
              <div class="counter-name">Years of Operation</div>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          <div class="statistic-item">
            ...
            <div class="content">
              <div class="statistic-counter">6</div>
